...
public class jDlgJMJ_BebidasPesquisar extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jDlgJMJ_BebidasPesquisar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jDlgJMJ_BebidasPesquisar dialog = new jDlgJMJ_BebidasPesquisar(new javax.swing.JFrame(), true);
