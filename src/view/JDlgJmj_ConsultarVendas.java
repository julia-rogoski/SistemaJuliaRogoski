...
public class JDlgJmj_ConsultarVendas extends javax.swing.JDialog {
     ...
     */
    public JDlgJmj_ConsultarVendas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgJmj_ConsultarVendas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgJmj_ConsultarVendas dialog = new JDlgJmj_ConsultarVendas(new javax.swing.JFrame(), true);
