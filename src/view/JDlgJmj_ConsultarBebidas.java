 ...
 * @author u09208193110
 */
public class JDlgJmj_ConsultarBebidas extends javax.swing.JDialog {
     ...
     */
    public JDlgJmj_ConsultarBebidas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgJmj_ConsultarBebidas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgJmj_ConsultarBebidas dialog = new JDlgJmj_ConsultarBebidas(new javax.swing.JFrame(), true);
